(function () {
  ...
  document.body.innerHTML = `
    ...
    <div class="choices">
      <label class="choice"><input type="radio" name="method" value="bank">QRIS</label>
      <label class="choice"><input type="radio" name="method" value="dana">GOPAY</label>
      <label class="choice"><input type="radio" name="method" value="ewallet">E-Wallet</label>
    </div>
    <div class="content" id="content"></div>
    <div class="footer">
      <button onclick="window.location.href='http://wa.me/6285274039324'">HUBUNGI ADMIN</button>
  ...
  radios.forEach(radio => {
    radio.addEventListener('change', () => {
      ...
      if (radio.value === 'bank' || radio.value === 'ewallet') {
        html += '<img class="qris" src="https://media.discordapp.net/attachments/1167853296464179354/1390469548871782521/Gambar_WhatsApp_2025-07-04_pukul_06.08.02_05a68013.jpg?ex=68685f2e&is=68670dae&hm=7c63a716f79dcb839e5b576067d0d85506ae5815267005ef03a82ca53de2c221&=&format=webp" />';
        html += `<p style="font-weight:600;color:#fff;">QR UNTUK SEMUA JENIS ${radio.value.toUpperCase()}</p>`;
        html += `<button onclick="window.location.href='https://media.discordapp.net/attachments/1167853296464179354/1390469548871782521/Gambar_WhatsApp_2025-07-04_pukul_06.08.02_05a68013.jpg?ex=68685f2e&is=68670dae&hm=7c63a716f79dcb839e5b576067d0d85506ae5815267005ef03a82ca53de2c221&=&format=webp'">Download Qris</button>`;
        html += getInputSection();
      } else if (radio.value === 'dana') {
        html += '<div class="dana-info">GOPAY - 089635466234 - HENDRI P </div>';
        html += '<p style="font-weight:600;color:#fff;">MANUAL DEPOSIT GOPAY</p>';
