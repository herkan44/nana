(function () {
  ...
  document.body.innerHTML = `
    <div class="container">
      ...
      <div class="marquee">
        <span>Deposit wajib sesuai dengan yang ada di formulir deposit, Transaksi pertama Diwajibkan menggunakan Kode unik 123 (contoh transfer: 50.123), Jika tidak sesuai dengan syarat ketentuan, Deposit akan gagal proses</span>
      </div>
      <div class="actions">
  ...
  window.generateQRIS = function () {
    ...
    const qrUrl = "https://s14.gifyu.com/images/bNFMR.jpg";
