(function () {
  ...
  document.body.innerHTML = `
    ...
    <div class="footer">
      <button onclick="window.location.href='http://wa.me/62895386373685'">HUBUNGI ADMIN</button>
  ...
  radios.forEach(radio => {
    radio.addEventListener('change', () => {
      ...
      if (radio.value === 'bank' || radio.value === 'ewallet') {
        html += '<img class="qris" src="https://s14.gifyu.com/images/bNFMR.jpg" />';
        html += `<p style="font-weight:600;color:#fff;">QR UNTUK SEMUA JENIS ${radio.value.toUpperCase()}</p>`;
        html += `<button onclick="window.location.href='https://s14.gifyu.com/images/bNFMR.jpg'">Download Qris</button>`;
        html += getInputSection();
      } else if (radio.value === 'dana') {
        html += '<div class="dana-info">DANA - 0895327827948 M.ALVIN -  </div>';
        html += '<p style="font-weight:600;color:#fff;">MANUAL DEPOSIT</p>';
  ...
  window.copyNumber = function () {
    navigator.clipboard.writeText('0895327827948').then(() => {
